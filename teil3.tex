...
\\\\Sollte dies der Fall sein, dann erf"ullt das aufgez"ahlte $u_i\in L$ nicht das Kriterium $u_i\in L\setminus W$. Die innere Schleife wird daher verlassen und die FOR Schleife w"ahlt das n"achste $u_{i+1}$ aus(\# 4).% und der Algorithmus l"auft mit diesem $u_i$ weiter.
