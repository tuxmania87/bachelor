...
\\\\Sollte dies der Fall sein, dann haben wir mit $v$ ein Präfix von $w$, werlches gegen die das $\min$ Kriterium verstö"st. Die innere Schleife wird dann verlassen und die FOR Schleife w"ahlt das n"achste $u_{i+1}$ aus(\# 4).% und der Algorithmus l"auft mit diesem $u_i$ weiter.
