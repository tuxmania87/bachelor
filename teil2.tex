...
\begin{beispiel}
Es seien $V=\{aab,ab\}$ und $W=\{a,abb,aaab\}$, so dass $\pref(V)=\{e,a,aa,ab,aab\}$. Dann haben wir $\pref(V)\ff W = \{a,aab,aaab\}$, aber $\pref(V) \cap W = \{a\}$ und $\min(\pref(V)\backslash\{e\}) \ff W = \{a,abb\}$
...
Zum Beweis der anderen Inklusion betrachten wir $w\in V\cdot X^* \ff W$. Es muss nun ein $v\in V\cdot X^*$ existieren, sodass $w\in \{v\}\ff W$ gilt. Daraus folgt, dass $v$ ein Präfix von $w$ sein muss, was wiederum bedeutet, dass $w\in V\cdot X^*$. Somit gilt die Inklusion $V\cdot X^* \ff W \subseteq W\cap V\cdot X^*$.
\end{proof}
...
Da $W\backslash V\cdot X^* \subseteq X^*\backslash V\cdot X^*$, wenden wir Lemma \ref{eingeschr1} an und erhalten (\ref{arr3}), was sich zu (\ref{arr4}) vereinfachen lässt.
\begin{eqnarray}
W\ff V\cdot X^* & = & (W\backslash V\cdot X^*) \ff V\cdot X^* \cup (W\cap V\cdot X^*) \label{arr1}\\
%V' &:= & W\backslash V\cdot X^* \label{arr2}\\
W\ff V\cdot X^* & = & W\backslash V\cdot X^*  \ff \min(V\cdot X^*) \cup (W\cap V\cdot X^*) \label{arr3} \\
