...
Aus der Definition wissen wir, dass $w\ff \pref(V)= \min ( \{w\} \cdot X^* \cap \pref(V) )$ entspricht. 
Sei $w'\in (\{w\} \cdot X^* \cap \pref(V))$, so sieht man leicht, dass $w\sqsubseteq w'$ und demnach $w\in\pref(V)$ gelten muss.
Daraus folgt sofort $\min ( \{w\} \cdot X^* \cap \pref(V) ) = \{w\} \cap \pref(V)$
...
Aus der Definition wissen wir, dass $v\ff W = \min( \{v\} \cdot X^* \cap W)$ entspricht. Da laut Voraussetzung $v\in V\cdot X^*$, so gilt = $\min( \{v\} \cdot X^* \cap W) = \min( \{v\} \cap W)$.
Da $\{v\} \cap W$ in jedem Fall einelementig ist, wissen wir, dass $\min( \{v\} \cap W) = \{v\} \cap W$ gilt.
