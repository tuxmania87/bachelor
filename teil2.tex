...
Im nun vorliegenden Abschnitt wird die Operation Fortsetzung im Hinblick auf Sprachen mit spezieller Gestalt untersucht. Dabei geht es hauptsächlich um Sprachen der Form $\pref(L)$ oder $W\cdot X^*$.
...
Die Fortsetzung von $W$ in $\cdot X^*$ lässt sich in zwei Teile aufspalten: $W\ff V\cdot X^* = (W\backslash V\cdot X^*) \ff V\cdot X^* \cup (W\cap V\cdot X^*)$.\\
