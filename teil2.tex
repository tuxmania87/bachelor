...
%\textbf{zu 1.} Es gen"ugt die Eigenschaft zu zeigen f"ur $V=\{v\}$\\
%\begin{proof}
...
F"ur die Umkehrung von Eigenschaft \ref{spezeig1} $\pref(V)\ff W$ gibt es keine Vereinfachung, wie das folgende Beispiel zeigt.
\begin{beispiel}
...
Zum Beweis der der anderen Inklusion gen"ugt es, diese f"ur den Fall $L=\{v\}$ zu zeigen.\\
Es sei nun $w\in v\ff W\cdot X^*$, wobei nach Vorraussetzung $v\notin W\cdot X^*$ gelte. Dann gilt f"ur kein $u$, $v\sqsubseteq u\sqsubset w$ oder $u\sqsubseteq v$ die Beziehung $u\in W\cdot X^*$.\\
