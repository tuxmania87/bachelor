...
Als Beispiel hatte ich, wie sie vorschlugen $A=\{n:\textit{n ist eine gerade Zahl}\}$ gewählt. Dann kommt meiner Meinung nach folgender Baum Zustande:\\
\includegraphics[scale=0.66]{entscheidbar.png}\\
Dabei besteht die Menge $0\ff W$ aus den rot-umrandeten Wörtern, also immer wenn $n\in A$ und $n\in \mathbb{N}$ dann kommt das echte Präfix in die Resultatmenge und wenn $n\in\mathbb{N}$ und $n\notin A$ dann kommt das ganze Wort rein, also:\\
