...
\end{eigen}
\begin{proof}
Nach Definition ist $L_1\ff L_2 = \bigcup_{l\in L_1} l\ff L_2$. Laut Vorbedinung gilt für jedes $l\in L_1$, dass $l\ff L_2 = \{l\}$ ist.
Damit ergibt sich $  \bigcup_{l\in L_1} \{l\} = L_1$
\end{proof}
...
\end{gleich}
\begin{proof}
$\textit{Da }L_2\subseteq L_1\textit{ gilt für alle }l\in L_2 \cap L_1: l\ff L_2=\{l\}$\\
Demnach ergibt sich dann für $\bigcup_{l\in L_1} l\ff L_2 = \bigcup_{l\in L_1} \{l\} = L_2$
\end{proof}

\subsection{Konkatenation}
Für die Konkatenation ergeben sich keine allgemeinen Eigenschaften.\\
...
außerdem gibt es andere Sprachen, sodass gilt
